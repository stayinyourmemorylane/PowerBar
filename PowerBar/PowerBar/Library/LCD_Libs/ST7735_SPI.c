...
#define SPI_RS PORTB0  // PIN9  RS PIN used for chosing data or command  
#define SPI_RST PORTB1 // PIN8
...
// MOSI          -- Pin 11
// Clock         -- Pin 13
#define ST7735_PINS_DDR DDRB   // data direction port for the pins 
#define ST7735_PINS PORTB
